      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">Manage and track your purchase requests</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 border-l-4 border-amber-500 transition-colors duration-200">
            <p className="text-gray-500 dark:text-gray-400 text-sm">Draft Orders</p>
        ...
        {orders.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-12 text-center transition-colors duration-200">
            ...
            <p className="text-gray-400 dark:text-gray-500 mt-2">Create your first order to get started</p>
            <button
              onClick={() => navigate('/create-order')}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {order.items.length > 4 && (
                          <span className="text-gray-500 dark:text-gray-400 text-sm">+{order.items.length - 4} more</span>
                        )}
                      </div>
                    </div>
